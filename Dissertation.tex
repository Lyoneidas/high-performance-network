...
\begin{table}[H]
	...
	\end{tabular}
\end{table}
The next section will introduce some established solutions for the end-to-end performances.
...
\begin{table}[H]
	...
	\begin{tabular}{@{}l|l@{}}
		...
		Main goal            & \begin{tabular}[c]{@{}l@{}}The main goal of this project is to establish an open-source\\ dual-feed handler, and run the experiments to prove that it is\\ usable\end{tabular} \\ \hline
		Analytical metrics   & \begin{tabular}[c]{@{}l@{}}Analytic metrics are derived from the experiments and needs to\\ be compared to the commercial solutions\end{tabular}                               \\ \hline
		Key features         & \begin{tabular}[c]{@{}l@{}}Investigating the key features: hardware topology, MPI-CH2 framework\\ and how they are combined together\end{tabular}                              \\ \hline
		Existed problems     & \begin{tabular}[c]{@{}l@{}}There are some existing problems to be solved, and leading to the future\\ work\end{tabular}                                                        \\ \hline
		Project expectations & \begin{tabular}[c]{@{}l@{}}This project is expected to be applicable using 10Gb Ethernet hardware.\\ Introduction about the planned implementation\end{tabular}                \\ \bottomrule
	\end{tabular}
\end{table}
\newpage
