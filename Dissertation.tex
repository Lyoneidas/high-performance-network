...
\begin{table}[H]
	...
	\begin{tabular}{@{}ll@{}}
		...
		System Requirements                                                                     & \begin{tabular}[c]{@{}l@{}}Showing system requirements based on the hardware\\ achieved, and simulation goals\end{tabular}                                                  \\ \hline
...
\begin{itemize}
	\item Implementing the dual-feed receiver hardware using the Raspberry Pi boards
	\item Implementing software on both the simulated sender and receivers for UDP packages
...
\subsection{Dual-feed receiver requirements}
...
\subsection{Sender and receiver of UDP packets}
